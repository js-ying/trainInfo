        ...
        <b-row class="justify-content-md-center">
          ...
          <b-col
            ...
            <p class="mt-4">
              ...
              3. 移除 所有彈跳視窗<br />
              4. 更新 起迄站互換功能位置<br />
              5. 部落格介紹 <a href="https://jsy.tw/blog/1525/" target="_blank">【作品】台鐵時刻查詢——查詢火車時刻，簡單又快速。</a>
            </p>
            ...
            <p class="mt-4">
              ...
              3. 每一結果會簡單呈現車次、車種、起迄站、時間範圍與列車服務（哺乳室、身障旅客專用車、訂便當服務、人車同行……）<br />
              ...
              <div id="icon-source">
                ...
                >
                  <img
                    class="mr-1"
                    width="15px"
                    :src="require('../assets/images/' + iconSource.imgName + '.png')"
                  >
                </a>
              </div>
              <div id="time">
